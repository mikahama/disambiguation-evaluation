...
for i in {1..10}
do
   python test_rnn_script.py --train_lang kpv est --test_lang est --seed 4568 --model_filepath "models/kpv est-est-4568_$i" --result_filepath "results/kpv est-est-4568_$i.json"
done
