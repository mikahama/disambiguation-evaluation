...
for i in {1..10}
do
   python test_rnn_script.py --train_lang sme --test_lang sme --seed 4568 --model_filepath "models/sme-sme-4568_$i" --result_filepath "results/sme-sme-4568_$i.json"
done
