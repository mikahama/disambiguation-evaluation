...
for i in {1..10}
do
   python test_rnn_script.py --train_lang myv sme --test_lang sme --seed 4568 --model_filepath "models/myv sme-sme-4568_$i" --result_filepath "results/myv sme-sme-4568_$i.json"
done
