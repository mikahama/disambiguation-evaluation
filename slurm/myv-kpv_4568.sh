...
for i in {1..10}
do
   python test_rnn_script.py --train_lang myv --test_lang kpv --seed 4568 --model_filepath "models/myv-kpv-4568_$i" --result_filepath "results/myv-kpv-4568_$i.json"
done
