...
for i in {1..10}
do
   python test_rnn_script.py --train_lang myv kpv --test_lang kpv --seed 1234 --model_filepath "models/myv kpv-kpv-1234_$i" --result_filepath "results/myv kpv-kpv-1234_$i"
done
