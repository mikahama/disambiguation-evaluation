...
for i in {1..10}
do
   python test_rnn_script.py --train_lang est kpv --test_lang kpv --seed 4568 --model_filepath "models/est kpv-kpv-4568_$i" --result_filepath "results/est kpv-kpv-4568_$i.json"
done
