...
for i in {1..10}
do
   python test_rnn_script.py --train_lang sme --test_lang myv --seed 1234 --model_filepath "models/sme-myv-1234_$i" --result_filepath "results/sme-myv-1234_$i"
done
