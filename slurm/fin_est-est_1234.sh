...
for i in {1..10}
do
   python test_rnn_script.py --train_lang fin est --test_lang est --seed 1234 --model_filepath "models/fin est-est-1234_$i" --result_filepath "results/fin est-est-1234_$i"
done
