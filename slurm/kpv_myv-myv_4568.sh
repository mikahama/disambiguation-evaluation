...
for i in {1..10}
do
   python test_rnn_script.py --train_lang kpv myv --test_lang myv --seed 4568 --model_filepath "models/kpv myv-myv-4568_$i" --result_filepath "results/kpv myv-myv-4568_$i.json"
done
