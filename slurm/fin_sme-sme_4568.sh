...
for i in {1..10}
do
   python test_rnn_script.py --train_lang fin sme --test_lang sme --seed 4568 --model_filepath "models/fin sme-sme-4568_$i" --result_filepath "results/fin sme-sme-4568_$i.json"
done
