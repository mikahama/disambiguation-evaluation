...
for i in {1..10}
do
   python test_rnn_script.py --train_lang est --test_lang sme --seed 1234 --model_filepath "models/est-sme-1234_$i" --result_filepath "results/est-sme-1234_$i"
done
