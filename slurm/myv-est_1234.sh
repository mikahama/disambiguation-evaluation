...
for i in {1..10}
do
   python test_rnn_script.py --train_lang myv --test_lang est --seed 1234 --model_filepath "models/myv-est-1234_$i" --result_filepath "results/myv-est-1234_$i"
done
