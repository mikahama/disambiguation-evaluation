...
for i in {1..10}
do
   python test_rnn_script.py --train_lang fin --test_lang fin --seed 4568 --model_filepath "models/fin-fin-4568_$i" --result_filepath "results/fin-fin-4568_$i.json"
done
