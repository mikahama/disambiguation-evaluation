...
for i in {1..10}
do
   python test_rnn_script.py --train_lang kpv fin --test_lang fin --seed 4568 --model_filepath "models/kpv fin-fin-4568_$i" --result_filepath "results/kpv fin-fin-4568_$i.json"
done
