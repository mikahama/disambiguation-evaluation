...
for i in {1..10}
do
   python test_rnn_script.py --train_lang fin myv --test_lang myv --seed 4568 --model_filepath "models/fin myv-myv-4568_$i" --result_filepath "results/fin myv-myv-4568_$i.json"
done
