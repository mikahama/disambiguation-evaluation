...
for i in {1..10}
do
   python test_rnn_script.py --train_lang kpv sme --test_lang sme --seed 4568 --model_filepath "models/kpv sme-sme-4568_$i" --result_filepath "results/kpv sme-sme-4568_$i.json"
done
