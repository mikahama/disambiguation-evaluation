...
for i in {1..10}
do
   python test_rnn_script.py --train_lang est myv --test_lang myv --seed 1234 --model_filepath "models/est myv-myv-1234_$i" --result_filepath "results/est myv-myv-1234_$i"
done
