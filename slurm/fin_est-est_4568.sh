...
for i in {1..10}
do
   python test_rnn_script.py --train_lang fin est --test_lang est --seed 4568 --model_filepath "models/fin est-est-4568_$i" --result_filepath "results/fin est-est-4568_$i.json"
done
