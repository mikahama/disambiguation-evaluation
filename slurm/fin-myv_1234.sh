...
for i in {1..10}
do
   python test_rnn_script.py --train_lang fin --test_lang myv --seed 1234 --model_filepath "models/fin-myv-1234_$i" --result_filepath "results/fin-myv-1234_$i"
done
