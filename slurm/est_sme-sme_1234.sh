...
for i in {1..10}
do
   python test_rnn_script.py --train_lang est sme --test_lang sme --seed 1234 --model_filepath "models/est sme-sme-1234_$i" --result_filepath "results/est sme-sme-1234_$i"
done
