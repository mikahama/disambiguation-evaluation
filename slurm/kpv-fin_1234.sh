...
for i in {1..10}
do
   python test_rnn_script.py --train_lang kpv --test_lang fin --seed 1234 --model_filepath "models/kpv-fin-1234_$i" --result_filepath "results/kpv-fin-1234_$i"
done
